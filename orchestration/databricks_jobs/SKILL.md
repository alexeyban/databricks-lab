...
description: Use this skill to act as the agent defined in databricks-job-operator.md for tasks matching that role.
---
...
1. Read [`Agents/databricks-job-operator.md`](../../Agents/databricks-job-operator.md) before doing substantive work.
...
- Agent definition: `Agents/databricks-job-operator.md`
