...
NOTEBOOKS_TO_NORMALIZE = [
    "ingestion/consumers/NB_ingest_to_bronze.ipynb",
    "processing/common/NB_catalog_helpers.ipynb",
    "processing/common/NB_schema_contracts.ipynb",
    "processing/common/NB_schema_drift_helpers.ipynb",
    "processing/common/NB_reset_tables.ipynb",
    "processing/silver/NB_process_to_silver.ipynb",
    "processing/silver/NB_process_products_silver.ipynb",
    "processing/silver/NB_process_payment_silver.ipynb",
]
            ...
            tasks=[
                {
                    ...
                    "notebook_task": {
                        "notebook_path": "processing/common/NB_reset_tables",
