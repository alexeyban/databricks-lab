    ...
    return {
        ...
        "tasks": [
            ...
            },
            {
                ...
                "run_if": "ALL_SUCCESS",
                "notebook_task": {
                    "notebook_path": "processing/silver/NB_process_to_silver",
                    "source": "GIT",
                },
                "timeout_seconds": 0,
            },
            {
                ...
                "run_if": "ALL_SUCCESS",
                "notebook_task": {
                    "notebook_path": "processing/silver/NB_process_products_silver",
                    "source": "GIT",
                },
                "timeout_seconds": 0,
            },
            {
                ...
                "run_if": "ALL_SUCCESS",
                "notebook_task": {
                    "notebook_path": "processing/silver/NB_process_payment_silver",
                    "source": "GIT",
                },
                "timeout_seconds": 0,
            },
