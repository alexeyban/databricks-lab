...
Usage:
    python3 reset_databricks_tables.py --notebook-path processing/common/NB_reset_tables \
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--notebook-path",
        default="processing/common/NB_reset_tables",
        help="Notebook path in the Databricks workspace or git repo (default: processing/common/NB_reset_tables)",
    )
