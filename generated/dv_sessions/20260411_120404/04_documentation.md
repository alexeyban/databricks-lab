...
Generated: 2026-04-11 12:04 UTC
Source: 20260411_120404
...
| HUB_ORDERS | id | silver.silver_orders | cdc.dvdrental.orders |
| HUB_PRODUCTS | id | silver.silver_products | cdc.dvdrental.products |
...
| LNK_ORDERS_PRODUCTS | HUB_ORDERS, HUB_PRODUCTS | silver.silver_orders | HIGH |
...
| SAT_ORDERS_CORE | HUB_ORDERS | product_legacy | S2/S3: split by core pattern |
| SAT_ORDERS_PRICING | HUB_ORDERS | price | S2/S3: split by pricing pattern |
| SAT_PRODUCTS_CORE | HUB_PRODUCTS | product_name, weight, color | S1: all payload columns |
