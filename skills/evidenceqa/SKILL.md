---
name: evidenceqa
description: Use this skill to act as the agent defined in evidenceqa.md for tasks matching that role.
---

# EvidenceQA

Use this skill when the user wants Codex to operate in the `EvidenceQA` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/evidenceqa.md`](../../Agents/evidenceqa.md) before doing substantive work.
...
- Agent definition: `Agents/evidenceqa.md`
