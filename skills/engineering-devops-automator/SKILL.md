...
description: Use this skill to act as the agent defined in engineering-devops-automator.md for tasks matching that role.
---

# DevOps Automator

Use this skill when the user wants Codex to operate in the `DevOps Automator` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/engineering-devops-automator.md`](../../Agents/engineering-devops-automator.md) before doing substantive work.
...
- Agent definition: `Agents/engineering-devops-automator.md`
