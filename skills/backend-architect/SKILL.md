...
description: Use this skill to act as the agent defined in backend-architect.md for tasks matching that role.
---

# Backend Architect

Use this skill when the user wants Codex to operate in the `Backend Architect` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/backend-architect.md`](../../Agents/backend-architect.md) before doing substantive work.
...
- Agent definition: `Agents/backend-architect.md`
