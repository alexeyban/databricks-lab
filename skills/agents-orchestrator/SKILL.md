...
description: Use this skill to act as the agent defined in agents-orchestrator.md for tasks matching that role.
---

# Agents Orchestrator

Use this skill when the user wants Codex to operate in the `Agents Orchestrator` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/agents-orchestrator.md`](../../Agents/agents-orchestrator.md) before doing substantive work.
...
- Agent definition: `Agents/agents-orchestrator.md`
