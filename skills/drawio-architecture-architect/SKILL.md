...
description: Use this skill to act as the agent defined in drawio-architecture-architect.md for tasks matching that role.
---

# drawio-architecture-architect

Use this skill when the user wants Codex to operate in the `drawio-architecture-architect` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/drawio-architecture-architect.md`](../../Agents/drawio-architecture-architect.md) before doing substantive work.
...
- Agent definition: `Agents/drawio-architecture-architect.md`
