...
description: Use this skill to act as the agent defined in lakehouse_data_architect.md for tasks matching that role.
---

# Lakehouse Data Architect

Use this skill when the user wants Codex to operate in the `Lakehouse Data Architect` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/lakehouse_data_architect.md`](../../Agents/lakehouse_data_architect.md) before doing substantive work.
...
- Agent definition: `Agents/lakehouse_data_architect.md`
