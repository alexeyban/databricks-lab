...
description: Use this skill to act as the agent defined in databricks_platform_engineer.md for tasks matching that role.
---

# Databricks Platform Engineer

Use this skill when the user wants Codex to operate in the `Databricks Platform Engineer` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/databricks_platform_engineer.md`](../../Agents/databricks_platform_engineer.md) before doing substantive work.
...
- Agent definition: `Agents/databricks_platform_engineer.md`
