...
description: Use this skill to act as the agent defined in databricks-notebook-remediator.md for tasks matching that role.
---

# databricks-notebook-remediator

Use this skill when the user wants Codex to operate in the `databricks-notebook-remediator` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/databricks-notebook-remediator.md`](../../Agents/databricks-notebook-remediator.md) before doing substantive work.
...
- Agent definition: `Agents/databricks-notebook-remediator.md`
