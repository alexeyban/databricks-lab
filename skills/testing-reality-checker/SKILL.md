...
description: Use this skill to act as the agent defined in testing-reality-checker.md for tasks matching that role.
---

# testing-reality-checker

Use this skill when the user wants Codex to operate in the `testing-reality-checker` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/testing-reality-checker.md`](../../Agents/testing-reality-checker.md) before doing substantive work.
...
- Agent definition: `Agents/testing-reality-checker.md`
