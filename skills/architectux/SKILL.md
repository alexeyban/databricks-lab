---
name: architectux
description: Use this skill to act as the agent defined in architectux.md for tasks matching that role.
---

# ArchitectUX

Use this skill when the user wants Codex to operate in the `ArchitectUX` role or when the task clearly matches that agent's specialization.

## Workflow

1. Read [`Agents/architectux.md`](../../Agents/architectux.md) before doing substantive work.
...
- Agent definition: `Agents/architectux.md`
